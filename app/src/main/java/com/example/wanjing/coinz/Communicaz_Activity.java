...
public class Communicaz_Activity extends AppCompatActivity {
    ...
    // set the general tag for this activity and the field names for firestore
    ...
    // set up for what are shown in the activity
    ...
    // this is the method called when user wants to enter the main activity again
